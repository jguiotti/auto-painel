...
- **Supabase**: keep migrations in `supabase/migrations/`; prefer giving the user SQL to run in the dashboard unless they explicitly request CLI push. **Local stack (Docker):** `packages/shared/docs/SUPABASE_LOCAL.md` — `npm run supabase:start`.
