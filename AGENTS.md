...
- **Fechamento épicos (jun/2026):** `packages/shared/docs/EPICS_CLOSURE_JUN2026.md` — `npm run verify:epics-closure`. Integrações Meta/classificados: `packages/shared/docs/INTEGRATIONS_DEPLOY.md`. Blueprint OLX/WebMotors/iCarros: `packages/shared/docs/CLASSIFIEDS_INTEGRATORS_BLUEPRINT.md`. **Vercel (4 apps):** `packages/shared/docs/VERCEL_DEPLOY.md`.
