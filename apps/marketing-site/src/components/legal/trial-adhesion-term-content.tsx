...
interface TrialAdhesionTermContentProps {
  showBackLink?: boolean;
}

export function TrialAdhesionTermContent({ showBackLink = true }: TrialAdhesionTermContentProps) {
  return (
    <>
      <p>
      ...
      <h2>8. Foro</h2>
      <p>
        Fica eleito o foro da Comarca de Mongaguá/SP, com renúncia a qualquer outro, por mais
