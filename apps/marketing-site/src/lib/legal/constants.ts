export const LEGAL_SITE_URL = "https://autopainel.com.br";

export const PRIVACY_EMAIL = "privacidade@autopainel.com.br";

export const CONTACT_EMAIL = "contato@autopainel.com.br";
