...
export default function TermosDeUsoPage() {
  return (
    ...
    >
      ...
      <p>
        O acesso ao painel da concessionária requer credenciais fornecidas após contratação. Você
        é responsável por manter suas credenciais seguras e pelo uso feito por sua equipe.
      </p>
      ...
      <p>
        Aplica-se a legislação brasileira. Fica eleito o foro da comarca do domicílio da
        contratante, salvo disposição contratual específica em contrato comercial.
      </p>
